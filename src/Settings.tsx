...
export class Settings {
    // General
    /** Default app name */
    static appName: string = 'VEK Archivator'
    /** Default version */
    ...
    static appDefaultPage: string = 'file-manager'
    /** Information on the lower left side of the title bar */
    static appTitleBarDescription: string = 'App for archiving files with a choice of algorithms'
    /** Developer credits that will be at the bottom of the application on the left side */
    static appDeveloperCredits: string = 'by: Vladislav Bocharov, Nikolay Khomyzhenko, Emil Markov'
